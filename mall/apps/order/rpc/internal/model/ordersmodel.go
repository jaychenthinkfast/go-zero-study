...
type (
	...
	OrdersModel interface {
		ordersModel
		CreateOrder(ctx context.Context, oid string, uid, pid uint64) error
	}
...
func (m *customOrdersModel) CreateOrder(ctx context.Context, oid string, uid, pid uint64) error {
